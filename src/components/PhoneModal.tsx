      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        >
          ...
          <div className="text-center space-y-2">
            ...
            <h3 className="text-2xl font-serif font-bold text-white break-keep">
              대표 전화번호 안내
            </h3>
          ...
          {/* Description */}
          <div className="mt-5 space-y-3 bg-navy-950/60 rounded-xl p-4 border border-slate-800 text-sm text-slate-300 leading-relaxed text-center break-keep">
            <p>
              아크메르 동탄은 현재 발표 준비 단계에 있습니다.<br />
          ...
          <div className="mt-6 flex flex-col gap-3">
            <button
              ...
              className="w-full flex items-center justify-center gap-2 py-3.5 px-4 rounded-xl bg-gradient-to-r from-gold-600 via-gold-500 to-gold-600 text-navy-950 font-bold hover:brightness-110 shadow-lg shadow-gold-500/20 transition-all duration-200 text-sm break-keep"
            >
