...
export default function FAQSection() {
  ...
  return (
    <section id="faq" className="py-24 relative bg-slate-950 text-white border-t border-slate-900">
            ...
            return (
              <motion.div
                ...
                className={`rounded-2xl border transition-all duration-300 overflow-hidden ${
                  isOpen
                    ? 'bg-navy-900/90 border-gold-500/50 shadow-xl shadow-gold-500/5'
                    : 'bg-navy-950/60 border-slate-800/80 hover:border-slate-700'
                }`}
              >
                {/* Question Row */}
                <button
                ...
                <AnimatePresence>
                  {isOpen && (
                    ...
                    >
                      <div className="px-5 pb-6 sm:px-6 sm:pb-6 pt-0 border-t border-slate-800/50">
                        <div className="mt-4 p-4 rounded-xl bg-navy-950/80 border border-slate-800 flex items-start gap-3 text-sm text-slate-300 leading-relaxed">
